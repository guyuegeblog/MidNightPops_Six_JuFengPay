package com.third.wechatv.wxapi;
...
import com.third.app.Activity.VipInfoActivity;
import com.third.app.Bean.Multi;
import com.third.app.Bean.PayType;
import com.third.app.Constant.Constant;
import com.third.app.Interface.PayInterface;
import com.third.app.Model.AppData;
import com.third.app.Model.PayResultQuery;
import com.third.app.Net.MobClick;
...
import com.third.app.WeiXin.Convert;
import com.third.app.WeiXin.GetIP;
import com.third.app.WeiXin.GetWxOrderno;
import com.third.app.WeiXin.ReqEntity;
import com.third.app.WeiXin.RequestHandler;
import com.third.app.ZhiFuBao.Alipay;
import com.third.app.ZhiFuBao.PayResult;
import com.third.app.ZhiFuBao.SignUtils;
...
public class WXPayEntryActivity extends AppCompatActivity implements IWXAPIEventHandler, PayInterface, Handler.Callback, Runnable {

    @Bind(R.id.fragment_user_video)
    FullScreenVideoView fragmentUserVideo;
...
//    LinearLayout linerOneYear;
    ...
    // 商户私钥，pkcs8格式
    public final String RSA_PRIVATE = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAIkmAk1OM8d4KtItnp6BpaxUXwDW4z0b80" +
            "qRU4zXz/oXQyujThahWxJugpmmkgJMhEfnGWZQ0ocRsP8JAjkAEzDDhAC922JmpbhV/eAGPVFZHXPLP5+5vUV3s6fjy+Q1aMdRu1TRszFEji" +
            "fJ/X34bGzcc96jNG3YTDenhoOFbyuxAgMBAAECgYBuq/pNkZ6dBy5e3qtSM0KS1p63WbCTvntMIAuw6vIMWTs9+pDoGBsau4yuGslWC5LvRu" +
            "CrPOs2TaNrmkRt5M6Wal+NQ/2DYpngs7C7iumYXfePmNUhlmYfooxNy6LC0P4Jq79biQooO0qj72bl/gYEwsgZjaV9JorANxVWJNHVQQJBAM3" +
            "blBfrChnhSNVIBoYWyd7iPQwHJSPi9gr2Y+vZMjB7EPkGZrn0AHUr3hCDq4uQfu1ikT3G1vxU4tGQAH6hfNkCQQCqjgKwCt2BZ1t1pbMu8n2L5" +
            "nIdu0qrbJ64wz83HIz4RBnVXTcgkC+s2d8QgyclvBkb5KA+8cKyR1C41XVexz6ZAkAttyeqMB4sJSWhh787I/BsuN1JwIR09cAiKxmBlNhaf9oD" +
            "E3LYtOEtJDLKhBMiiVJGsW8DwxaXLtq4IzyY4o/xAkAEYpRVHGJnklW6p6D8wwVRVIJ4mzknQSqvi22TqCtDstSLNNNXBf4DzrI6hXS7NqPaoL0y" +
            "ARtFZCoCJpLW9f55AkEAreHy+PEzaCTdqsY8UbkDG660sE0vQI0mIdZL4mfG3DD6inJoDl2t+CPYCJFgHZUJPflEb2sOhk6RMvkNFmcGcw==\n";
    // 支付宝公钥
    public final String rsa_public = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCJJgJNTjPHeCrSLZ6egaWsVF8A1uM9G/NKkVOM18/6F0Mro" +
            "04WoVsSboKZppICTIRH5xlmUNKHEbD/CQI5ABMww4QAvdtiZqW4Vf3gBj1RWR1zyz+fub1Fd7On48vkNWjHUbtU0bMxRI4nyf19+Gxs3HPeozRt" +
            "2Ew3p4aDhW8rsQIDAQAB";
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    try {
                        ...
                        if (!TextUtils.isEmpty(prepay_id)) {
                            ...
                            Log.i("qianming", "appid  " + appid + "  partnerid" + mch_id + "  prepayid " + prepay_id +
...
//            Log.i("wxoutrade", WX_out_trade_no);
//            String areaChannel = ApkTool.getAppChannels(mContext, AppData.UMENG_APP_CHANNEL);
//            //String.valueOf(Integer.parseInt(pay_Price) * 100)
//            CNPay.getInstance().GoBuy(this, String.valueOf(Integer.parseInt("1")), body, areaChannel, 5, true, WX_out_trade_no, new ReBackListener() {
//                @Override
//                public void onAction(int success, Object o) {
//                    if (success == 200) {
//                        //支付成功
//                        Log.i("succesSte", "成功");
//                        T.showTextCenterToast(mContext, "支付成功");
//                        query_Zfb_PayResesult();
//                    } else {
//                        //支付失败
//                        Log.i("succesSte", "失败");
//                        T.showTextCenterToast(mContext, "支付失败");
...
//            });
    ...
    public void onResp(BaseResp resp) {
        ...
        switch (code) {
            ...
            case -1:
                ...
                T.showTextToast(mContext, "签名错误、未注册APPID、项目设置APPID不正确、注册的APPID与设置的不匹配、其他异常等。");
                break;
            case -2://用户取消支付后的界面
                T.showTextToast(mContext, "您取消了支付");
                Multi.Moon_LEVE = Multi.Moon_LEVE2;
                Multi.LIVE_UNBIND = true;
                alertIntentLive();
                break;
    ...
    private void initPlayer() {
        ...
        fragmentUserVideo.setPlayPauseListener(new FullScreenVideoView.PlayPauseListener() {
            @Override
            public void onPlay() {
...
//            }
        ...
        String aesJson = JSONObject.toJSONString(resultQuery);
...
//              layout.getBackground().setAlpha(150);
                ...
                final FullScreenVideoView videoView = (FullScreenVideoView) layout.findViewById(R.id.video);
                ...
                videoView.setPlayPauseListener(new FullScreenVideoView.PlayPauseListener() {
                    @Override
                    public void onPlay() {
