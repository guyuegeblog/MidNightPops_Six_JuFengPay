...
import com.third.app.Adapter.Look_MultiAdapter;
import com.third.app.Bean.LookType;
...
import com.third.app.Model.Comment;
import com.third.app.Model.CommentInfo;
import com.third.app.Model.LookInfo;
import com.third.app.Model.PayPrice;
import com.third.app.Model.RequestIp;
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    commentInfos = comment.getCommentJson();
                    if (commentInfos == null || commentInfos.size() == 0) {
                        return;
                    }
                    DBManager.getDBManager(mContext).addCommentData(commentInfos);
                } catch (Exception e) {
                    return;
                }
            }
