...
import com.third.app.Adapter.RedDiamond_MultiAdapter;
import com.third.app.Bean.Multi;
import com.third.app.Model.CompreHenSiveMode;
...
import com.third.app.View.Level_MarginDecoration;
...
public class RedDiamondFragment extends LazyFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getNetLookData(String type) {
        ...
        String aesJson = JSONObject.toJSONString(compreHenSiveMode);
