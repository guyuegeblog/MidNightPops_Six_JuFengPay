...
import com.third.app.Adapter.FragmentAdapter;
...
import com.third.app.Service.FifteenMinituesService;
...
public class MainActivity extends BaseActivity {
    ...
    private String vipApkName = "安装包6.apk";
...
//            showLiveMenuTishi.setVisibility(View.GONE);
    ...
    private void initService() {
        if (!isBind) {
            ...
            isBind = mContext.bindService(new Intent(mContext, FifteenMinituesService.class), fifteenService, Context.BIND_AUTO_CREATE);
...
//          layout.getBackground().setAlpha(150);
            ...
            if (vipType == Multi.VIP_SILVER_TYPE ||
                    ...
                    vipType == Multi.VIP_CROWN_TYPE) {
                mSpannableStringBuilder.setSpan
                        (new ForegroundColorSpan(this.getResources().getColor(R.color.danhuang)), 0, 5, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                mSpannableStringBuilder.setSpan
